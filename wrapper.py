...
class SEAL:
	...
	def __init__(self):
		self.lib = ctypes.cdll.LoadLibrary('./SEAL/libseal_192.so')
		for i in range(5):
			if (not (
				...
				self.lib.generate_new_keys(192, 4096)
				print("Done.")
				break
		self.lib.initialize(192,4096)
		...
		self.n_parm = 4096
		# q
		self.q_list = [36028797014376449, 36028797013327873, 1152921504241942529, 1152921504369344513, 1152921504321372161]
		# t
		self.t_list = t_list
		# k
		q = 1
